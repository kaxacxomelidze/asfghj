...
$pageTitle = 'საქართველოს სტუდენტური პარლამენტი და მთავრობა — პარლამენტში დამატება';
$metaDescription = 'სტუდენტური პარლამენტის წევრის დამატების გვერდი — ატვირთეთ ფოტო, სახელი, გვარი და როლი.';
$metaKeywords = 'სტუდენტური პარლამენტი, წევრის დამატება, ახალგაზრდობა, ახალგაზრდები, ტრენინგი, შეხვედრა, ბანაკი';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (!$errors) {
    try {
      ...
      $ok = 'თქვენი პროფილი წარმატებით დაემატა სტუდენტური პარლამენტის გვერდს.';
...
<section class="section">
  <div class="container" style="max-width:860px;padding:36px 0 58px;display:grid;gap:14px">
    <div style="background:#fff;border:1px solid var(--line);border-radius:18px;padding:20px">
      <h1 style="margin:0 0 8px">სტუდენტური პარლამენტის წევრის დამატება</h1>
      ...
      <div style="margin-top:12px"><a class="btn" href="<?=h(url('parlament'))?>">← პარლამენტის გვერდზე დაბრუნება</a></div>
    </div>
